...
@Component({
  ...
  template: `
    <div class="dlg-header">
      ...
      <div>
        <div class="dlg-title">New Message</div>
        <div class="dlg-subtitle">Start a conversation with your accountant</div>
      </div>
    </div>
    <mat-dialog-content>
      <form [formGroup]="form" id="newPortalThreadForm" (ngSubmit)="submit()" class="dlg-form">
    ...
    <mat-dialog-actions class="dlg-actions">
      ...
      <button mat-flat-button class="dlg-submit" form="newPortalThreadForm" type="submit">Send Message</button>
    </mat-dialog-actions>
  `,
  styles: [`
    .dlg-header {
...
export class NewPortalThreadDialogComponent {
  private dialogRef = inject(MatDialogRef<NewPortalThreadDialogComponent>);
