...
The system SHALL authenticate users via Google OAuth2 and, on success, issue a signed JWT stored as an `httpOnly`, `SameSite=Strict` cookie. The cookie SHALL NOT be accessible to JavaScript.
