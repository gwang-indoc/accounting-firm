# user-email-lookup Specification

## Purpose
Provides an admin-only endpoint to resolve a registered user's display name by email address. Used by the Add Client dialog to validate that a prospective client has an account before creation.
## Requirements
